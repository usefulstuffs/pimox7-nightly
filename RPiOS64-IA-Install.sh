...
deb https://raw.githubusercontent.com/usefulstuffs/pimox7-nightly/master/ dev/ \n" > /etc/apt/sources.list.d/pimox.list
curl https://raw.githubusercontent.com/usefulstuffs/pimox7-nightly/master/KEY.gpg |  apt-key add -
